      ...
      <section className="bg-muted/30 border-b border-border/40">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          ...
          <h1 className="font-heading text-4xl sm:text-5xl mb-5 leading-tight">
            Tech cu un pic mai multă sinceritate decât se obișnuiește.
          </h1>
          <p className="text-muted-foreground text-lg leading-relaxed max-w-2xl mx-auto">
            Pe TrenduriDigitale vorbim despre smartphone-uri, tablete, gadgeturi, hardware, internet, Social Media și AI. Fără artificii, fără să aplaudăm orice lansare doar pentru că „așa se face".
          </p>
        </div>
      </section>
